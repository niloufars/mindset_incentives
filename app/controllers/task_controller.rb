  ...
  def index
    ...
    @all_users.each do |u|
      ...
      all_tasks.where(workerID: u).each do |t|
        ...
        if ( t.condition == 'gp' && t.accuracy!=0 && t.taskstage == 3 ) 
          @gp += t.accuracy
          #@gp += t.taskstage
          @gp_n += 1
        elsif ( t.condition == 'gn' && t.accuracy!=0 && t.taskstage == 3) 
          @gn += t.accuracy 
          #@gn += t.taskstage
          @gn_n += 1
        elsif ( t.condition == 'cp' && t.accuracy!=0 && t.taskstage == 3) 
          @cp += t.accuracy 
          #@cp += t.taskstage
          @cp_n += 1
        elsif ( t.condition == 'cn' && t.accuracy!=0 && t.taskstage == 3) 
          @cn += t.accuracy 
          #@cn += t.taskstage
          @cn_n += 1
        end
